...
public class GrupoTareaServiceImpl implements GrupoTareaService {
	...
	public List<GrupoTareaDTO> get(GrupoTareaDTO grupoTarea) throws Exception {
		logger.debug("[INICIO] - getGrupoTareas - Filtro: - " + grupoTarea.toString());
		return this.grupoTareaDAO.get(grupoTarea);
	}

	@Transactional(propagation = Propagation.REQUIRED, rollbackFor = Exception.class)
	public GrupoTareaDTO add(GrupoTareaDTO grupoTarea) throws Exception {
	...
	@Transactional(propagation = Propagation.REQUIRED, rollbackFor = Exception.class)
	public GrupoTareaDTO update(GrupoTareaDTO grupoTarea) throws Exception {
	...
	@Transactional(propagation = Propagation.REQUIRED, rollbackFor = Exception.class)
	public Boolean delete(GrupoTareaDTO grupoTarea) throws Exception {
