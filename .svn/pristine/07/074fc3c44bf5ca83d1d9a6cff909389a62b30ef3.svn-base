...
idEstimacion int(11) PRIMARY key,
idProyecto int(11) REFERENCES proyectos(idProyecto),
fechaRealizacion date,
estimadoPor int(11) references personas(idPersona),
comentarios varchar(200)

)

create table pasos(
idPaso int(11) PRIMARY KEY not null,
idFuncionalidad int(11) not null references funcionalidades(idFuncionalidad),
idTarea int(11) not null references tareas(idTarea),
