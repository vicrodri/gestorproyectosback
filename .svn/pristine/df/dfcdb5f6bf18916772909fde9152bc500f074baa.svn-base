...
public class TareaServiceImpl implements TareaService {
	...
	public List<TareaDTO> get(TareaDTO tarea) throws Exception {
		logger.debug("[INICIO] - getTareas - Filtro: - " + tarea.toString());
		return this.tareaDAO.get(tarea);
	}

	@Transactional(propagation = Propagation.REQUIRED, rollbackFor = Exception.class)
	public TareaDTO add(TareaDTO tarea) throws Exception {
		logger.debug("[INICIO] - addTarea - Tarea: - " + tarea.toString());
		
		List <GrupoTareaDTO> grupoTareas = this.grupoTareaService.get(tarea.getGrupoTarea());
	...
	@Transactional(propagation = Propagation.REQUIRED, rollbackFor = Exception.class)
	public TareaDTO update(TareaDTO tarea) throws Exception {
	...
	@Transactional(propagation = Propagation.REQUIRED, rollbackFor = Exception.class)
	public Boolean delete(TareaDTO tarea) throws Exception {
	...
	public List<TareaDTO> getAllTareas() throws Exception {
